...
Al ocurrir el rol en un **videojuego** o **entorno de simulación**, en este caso, **ER:LC**, nos enfrentamos a varias barreras, como la **limitación** en lo que podemos hacer dentro del **juego**, por eso usamos **/me** y **/do**.
...
Se usa /do para expresar una **condición o hecho** que ocurre **en el entorno**, una **aclaración** o una **interrogación** después de una acción como **consecuencia** de esta. Por ejemplo, después del primer /me del ejemplo anterior:

<mark style="color:$primary;">/do se vería que está agitado y empieza a sudar.</mark>\ <mark style="color:$primary;">/do se le cae un cargador de pistola del bolsillo izquierdo y lo pisa.</mark>

#### Ejemplo

A continuación, vamos a hacer un **ejemplo** de rol, donde el <mark style="color:cyan;">azul</mark> representa a un policía y el <mark style="color:$primary;">rosa</mark> a un criminal.

Aquí el policía **intenta engrilletar** a un criminal, pues a menos que esté **abatido** o **debilitado** puede **resistirse**. El criminal **puede** resistirse **una** vez como máximo, si no, se consideraría “**Forzar Rol**”, pues **no** puedes resistirte a ser **engrilletado** (que te pongan las esposas) **infinitamente**.
